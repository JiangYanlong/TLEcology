...
public class HistoryJob extends BaseCronJob {
    ...
    public void syn() {
        ...
        try {
            ...
            e1.printStackTrace();
            bean.writeLog("链接门禁数据库异常："+e1.getMessage());
        }
...
//            }
    ...
    public void synYj(String date){
        ...
        String getallcxsql = "select b.nodeid,b.workflowid,a.* from formtable_main_23 a, workflow_currentoperator b "+
                "where a.requestid = b.requestid and b.workflowid= '5164' and a.yjccksrq = '"+date+"' and b.nodeid not in (11294,11291,11293,11298,11285,11292)";
    ...
    public void synCC(String date){
        ...
        //同步出差
        String getallcxsql = "select b.nodeid,b.workflowid,a.* from formtable_main_23 a, workflow_currentoperator b "+
                "where a.requestid = b.requestid and b.workflowid= '5164' and a.sjccksrq between '"+date+"' and '"+date+"' and b.nodeid in (11294)";
