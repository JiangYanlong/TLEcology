...
<div id="showdatadiv" style="width:100%;margin:0 auto">
...
function showdata(){
    var ajax=ajaxinit();
    ajax.open("POST", "hzkqoperationdatas.jsp", true);
...
function doExportExcel(){
	jQuery("#excel").attr('src','hzkqexportexcel.jsp?fromdate2=<%=fromdate2%>&department=<%=department%>');
}
function printf(){
