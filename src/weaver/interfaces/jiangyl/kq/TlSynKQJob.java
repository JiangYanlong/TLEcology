...
public class TlSynKQJob extends BaseCronJob {
	...
	public void synDay(String date){
		...
		dataSource.execute("select a.emp_id,a.sign_time,a.card_id,b.clock_name from TimeRecords a, Clocks b where a.clock_id = b.clock_id and a.sign_time between '"
				+ sbeginDate
				+ "' and '"
				+ searchEndDate
...
//        String nowDate = now.split(" ")[0];
		...
		while (recordset.next()) {
			String creater = Util.null2String(recordset.getString("creater"));// 创建者
			String date1 = Util.null2String(recordset.getString("date1"));// 创建者
			String empid = getEmpId(creater);
			String lskh = Util.null2String(recordset.getString("desc11"));// 临时卡卡号
			dataSource.execute("select a.emp_id,a.sign_time,a.card_id,b.clock_name from TimeRecords a, Clocks b where a.clock_id = b.clock_id and a.sign_time between '"
					+ date1
					+ " 00:00:01"
					+ "' and '"
		...
		while (rsset.next()) {
			String sqr = Util.null2String(rsset.getString("creater"));
			String datejl = Util.null2String(rsset.getString("date1"));
			String time1 = Util.null2String(rsset.getString("time1"));
			String time2 = Util.null2String(rsset.getString("time2"));
